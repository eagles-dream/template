...
export default function Google({coupangData2, }) {
  ...
  const listsFinal = [...lists2End, /* ...lists3End, ...lists4End */]
...
export async function getStaticProps() {  
  const [coupangRes2, ] = await Promise.all([
  ...
  const [coupangData2, ] = await Promise.all([
    //coupangRes1.data,
    coupangRes2.data,
    //coupangRes3.data,
    //coupangRes4.data,
